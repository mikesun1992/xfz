$(function() {
	$(".shareLi").hover(function() {
		var $ids = $(".shareLi").index(this);
		$(this).find("a").toggleClass("lth" + $ids)
	});
	var qjjtt_swiper = new Swiper(".qjjtt-swiper", {
		...
		onSlideChangeStart: function(swiper) {
			$(".qjjtt-swiper .pagination").html("<span>" + (qjjtt_swiper.activeLoopIndex + 1) + "</span>/" + ($(".qjjtt-swiper .swiper-slide").length - 2))
		}
	});
	var qjj_swiper = new Swiper(".qjj-swiper", {
		pagination: ".pagination",
		paginationType: "fraction",
		loop: true,
		autoplay: 1e4,
		speed: 500,
		onSlideChangeStart: function(swiper) {
			$(".qjj-swiper .pagination").html("<span>" + (qjj_swiper.activeLoopIndex + 1) + "</span>/" + ($(".qjj-swiper .swiper-slide").length - 2))
		}
	});
	$(".qjjtt-swiper .arrow1L").on("click", function(e) {
		e.preventDefault();
		qjjtt_swiper.swipePrev()
	});
	$(".qjjtt-swiper .arrow1R").on("click", function(e) {
		e.preventDefault();
		qjjtt_swiper.swipeNext()
	});
	$(".qjj-swiper .arrow1L").on("click", function(e) {
		e.preventDefault();
		qjj_swiper.swipePrev()
	});
	$(".qjj-swiper .arrow1R").on("click", function(e) {
		e.preventDefault();
		qjj_swiper.swipeNext()
	});
	$(window).load(function() {
		$(".qjjtt-swiper .pagination").html("<span>" + (qjjtt_swiper.activeLoopIndex + 1) + "</span>/" + ($(".qjjtt-swiper .swiper-slide").length - 2));
		$(".qjj-swiper .pagination").html("<span>" + (qjj_swiper.activeLoopIndex + 1) + "</span>/" + ($(".qjj-swiper .swiper-slide").length - 2))
	});
	$(".imgTxtswiper .swiper-pagination-switch").each(function() {
		$(this).hover(function() {
			imgTxtswiper.swipeTo($(this).index(), 500, false)
		})
	});
	$(".imgTxtswiper,.focus980").bind("mouseenter", function() {
		$(this).find(".arrow1").show()
	}).bind("mouseleave", function() {
		$(this).find(".arrow1").hide()
	});
	$(".arrow1L,.arrow1R").hover(function() {
		$(this).css({
			opacity: "0.6",
	...
	var rwSwiper = new Swiper(".rw-swiper-container", {
		loop: true,
		grabCursor: true,
		slidesPerView: 3,
		spaceBetween: 15,
	...
	$(".rw .arrow-left").on("click", function(e) {
		e.preventDefault();
		rwSwiper.swipePrev()
	});
	$(".rw .arrow-right").on("click", function(e) {
		e.preventDefault();
		rwSwiper.swipeNext()
	});
	$(".rwJdt .arrow-left,.rwJdt .arrow-right").hover(function() {
		$(this).css({
			opacity: 1,
	...
	var rwSwiper2 = new Swiper(".rw-swiper-container2", {
		loop: true,
		grabCursor: true,
		slidesPerView: 3,
		spaceBetween: 15,
	...
	$(".rwJdt2 .arrow-left2,.rwJdt2 .arrow-right2").hover(function() {
		$(this).css({
			opacity: 1,
			filter: "alpha(opacity=100)"
		})
	...
	$(".rw2 .arrow-left2").on("click", function(e) {
		e.preventDefault();
		rwSwiper2.swipePrev()
	});
	$(".rw2 .arrow-right2").on("click", function(e) {
		e.preventDefault();
		rwSwiper2.swipeNext()
	});

/*************县区园区篇（3）开始*****************/
var rwSwiper3 = new Swiper(".rw-swiper-container3", {
		loop: true,
		grabCursor: true,
		slidesPerView: 3,
		spaceBetween: 15,
	...
	$(".rwJdt3 .arrow-left2,.rwJdt3 .arrow-right3").hover(function() {
		$(this).css({
			opacity: 1,
			filter: "alpha(opacity=100)"
		})
	...
	$(".rw3 .arrow-left3").on("click", function(e) {
		e.preventDefault();
		rwSwiper3.swipePrev()
	});
	$(".rw3 .arrow-right3").on("click", function(e) {
		e.preventDefault();
		rwSwiper3.swipeNext()
	});
/*************县区园区篇（3）结束*****************/
...
/*************乡镇街道篇（4）开始*****************/
var rwSwiper4 = new Swiper(".rw-swiper-container4", {
		loop: true,
		grabCursor: true,
		slidesPerView: 3,
		spaceBetween: 15,
	...
	$(".rwJdt4 .arrow-left4,.rwJdt4 .arrow-right4").hover(function() {
		$(this).css({
			opacity: 1,
			filter: "alpha(opacity=100)"
		})
	...
	$(".rw4 .arrow-left4").on("click", function(e) {
		e.preventDefault();
		rwSwiper4.swipePrev()
	});
	$(".rw4 .arrow-right4").on("click", function(e) {
		e.preventDefault();
		rwSwiper4.swipeNext()
	});
/*************乡镇街道篇（4）结束*****************/
